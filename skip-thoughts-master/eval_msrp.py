...
def evaluate(encoder, k=10, seed=1234, evalcv=True, evaltest=False, use_feats=True, loc='/content/drive/My Drive/Testing/Text/Paraphrase_Detection/'):
    """
    Run experiment
...
def load_data(loc='/content/drive/My Drive/Testing/Text/Paraphrase_Detection/'):
    """
    Load MSRP dataset
    """
