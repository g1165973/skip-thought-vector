...
def evaluate(encoder, seed=1234, evaltest=False, loc='/content/drive/My Drive/Testing/Text/Semantic_Relatedness/'):
    """
    Run experiment
    """
...
def load_data(loc='/content/drive/My Drive/Testing/Text/Semantic_Relatedness/'):
    """
